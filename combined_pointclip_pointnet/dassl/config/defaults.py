...
_C.DATALOADER.TRAIN_X.SAMPLER ='SequentialSampler'
_C.DATALOADER.TRAIN_X.BATCH_SIZE = 100
...
_C.DATALOADER.TRAIN_U.SAMPLER = 'SequentialSampler'
_C.DATALOADER.TRAIN_U.BATCH_SIZE = 100
