...
from pointclip_sch.trainers.mv_utils_zs import PCViews
from pointclip_sch.clip import clip


CUSTOM_TEMPLATES = {
    'ModelNet40': 'point cloud depth map of a {}.',
    'ScanObjectNN': 'point cloud depth map of a {}.'
}
...
class PointCLIP_ZS(TrainerX):
    ...
    def model_inference(self, pc, label=None):
        ...
        with torch.no_grad():
            ...
            logits_test=image_feat @ text_feat.t() * 1.0
