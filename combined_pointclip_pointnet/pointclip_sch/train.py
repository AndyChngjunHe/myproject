...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='data/modelnet40_ply_hdf5_2048', help='path to dataset')
    parser.add_argument(
        '--output-dir', type=str, default='output/PointCLIP_ZS/rn50/modelnet40', help='output directory'
    )
    parser.add_argument(
        '--resume',
        type=str,
    ...
    parser.add_argument(
        '--config-file', type=str, default='configs/trainers/PointCLIP_ZS/rn50.yaml', help='path to config file'
    )
    parser.add_argument(
        '--dataset-config-file',
        type=str,
        #default='configs/datasets/scanobjectnn.yaml',
        default='configs/datasets/modelnet40.yaml',
    ...
    parser.add_argument(
        '--zero-shot', action='store_true', help='zero-shot only',default=False
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--no-train', action='store_true', help='do not call trainer.train()',default=False
    )
    parser.add_argument(
        'opts',
        default=None,
